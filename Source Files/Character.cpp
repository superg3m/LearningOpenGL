...
void Character::init()
{
    ...
    if (FT_New_Face(this->ft, "Fonts/calibri.ttf", 0, &this->face)) {
...
void Character::renderText(Shader& shader, std::string text, float x, float y, float scale, glm::vec3 color)
{
